...
public function filter_default_loan(){
	...
	$this->load->view('admin/filter_defaultloan',['blanch'=>$blanch,'default_blanch'=>$default_blanch,'total_blanch'=>$total_blanch,'blanch_data'=>$blanch_data,'blanch_id'=>$blanch_id]);
}
...
public function print_default_loan($blanch_id){
    ...
    $blanch_data = $this->queries->get_blanch_data($blanch_id);
    $mpdf = new \Mpdf\Mpdf(['mode' => 'utf-8','format' => 'A4-L','orientation' => 'L']);
    $html = $this->load->view('admin/default_report',['compdata'=>$compdata,'default_blanch'=>$default_blanch,'total_blanch'=>$total_blanch,'blanch_data'=>$blanch_data,'blanch_id'=>$blanch_id],true);
    $mpdf->SetFooter('Generated By Brainsoft');
