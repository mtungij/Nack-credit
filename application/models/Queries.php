...
public function get_customer_data($customer_id){
	$customer = $this->db->query("SELECT c.customer_id,c.blanch_id,c.comp_id,c.empl_id,e.empl_name FROM tbl_customer c LEFT JOIN tbl_employee e ON e.empl_id = c.empl_id  WHERE c.customer_id = $customer_id");
	  return $customer->row();
}
